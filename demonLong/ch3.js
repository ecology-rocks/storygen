...
p1as1a: pep.seq('The moon hung low in the sky as ', names.c0, ' walked across the courtyard and into the administrative building that led to freedom. '),
p1as1b: pep.seq(names.c0, ' crunched through the courtyard towards the ominous administrative building. '),
p1as1c: pep.seq('The moon hung ominously over the administration building as ', names.c0, ' made ', myPep.pronouns.their(names.c0g), ' way home. '),

p1as2a: pep.seq('It had been a long shift, but it was over and ', names.c0, ' could not wait to crawl into bed. '),
p1as2b: pep.seq(names.c0, ' was thankful that the arduous shift was over. '),
p1as2c: pep.seq(names.c0, '\'s thoughts drifted as ', myPep.pronouns.they(names.c0g), ' tried to shake off the long night. '),
...
p2as1b: pep.seq('The door opened with a creak as names.c0 stepped into the dimly lit hallway. '),
p2as1c: pep.seq(names.c0, ' always felt like ', myPep.pronouns.they(names.c0g), ' were part of some murder mystery when entering the gate building late at night. '),

p2as2a: pep.seq('Despite it being the literal changing of the guard, all of the day staff were gone. '),
p2as2b: pep.seq('It was amazing to ', names.c0, ' how empty the gate building was, despite the shift change at this hour. '),
p2as2c: pep.seq('The hallway smelled faintly of farm animal and gunpowder. '),

p2as3a: pep.seq('The preternatural quiet was harshly interrupted by ', names.c0, '\'s combat books clunking upon the stone floor. '),
p2as3b: pep.seq(names.c0, '\'s boots disrupted the quiet hallway as they clattered against the stone. '),
p2as3c: pep.seq('The hallway was quiet, punctuated only by ', names.c0, '\'s heavy breath and boots upon the floor. '),

  //p3
  
  p3as1a: pep.seq(names.c0, ' turned a corner and found ', myPep.pronouns.themself(names.c0g), ' in the midst of chaos. '),
  p3as1b: pep.seq(names.c0, ' abruptly found ', myPep.pronouns.themself(names.c0g), ' surrounded by activity as ', myPep.pronouns.they(names.c0g), ' rounded the corner. '),
  p3as1c: pep.seq(names.c0, ' heard voices just around the bend. '),

  p3as2a: pep.seq('The lights were much brighter here, and orange cones and caution tape blocked ', myPep.pronouns.their(names.c0g), ' path. '),
  p3as2b: pep.seq('The flood lights reflected off of the bright orange safety cones and caution tape fluttered in the wind. '),
  p3as2c: pep.seq(names.c0, ' saw several folks on the other side of orange cones and caution tape. '),
  
  p3as3a: pep.seq('A fellow guard, weapon loose in hands, nodded abruptly at ', names.c0, '. '),
  p3as3b: pep.seq('The guard closest to ', names.c0, ' grunted. '),
  p3as3c: pep.seq(names.c0, ' saw the nearest guard eyeing ', myPep.pronouns.them(names.c0g), '. '),
...
p5as2a: pep.seq(names.c0, ' offered, surveying past the soldier to the fresh splats of blood on the wall. '),
p5as2b: pep.seq('names.c0 wondered what the story was. '),
p5as2c: pep.seq('names.c0 offered absentmindedly, immediately regretting the decision. '),

p5as3a: pep.seq(myPep.setting.brethrens(names.setVar), ' in hazmat suits were hard at work. '),
p5as3b: pep.seq('The hazmats buzzed around behind the guard like busy little bees. '),
p5as3c: pep.seq('Hazmatted ', myPep.setting.brethrens(names.setVar), ' were staring. '),
...
p6as4a: pep.seq('The soldier took a breath and ',names.c0, ' realized belatedly that there was fresh blood on the sword that the guard held. '),
p6as4b: pep.seq(''),
p6as4c: pep.seq(''),

p6as5a: pep.seq(pep.capitalize(myPep.pronouns.their(names.c0g)), ' stomach turned. '),
p6as5b: pep.seq(''),
p6as5c: pep.seq(''),
...
p8as2a: pep.seq(names.c0, ' did a small salute and turned to walk away. '),
p8as2b: pep.seq(''),
p8as2c: pep.seq(''),
...
p9as2a: pep.seq('The soldier shouted as ', names.c0, ' departed. '),
p9as2b: pep.seq(''),
p9as2c: pep.seq(''),

p9as3a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' were unsure what to make of the scene, but bed still called ', myPep.pronouns.their(names.c0g), ' name. '),
p9as3b: pep.seq(''),
p9as3c: pep.seq(''),
...
p10as2a: pep.seq(names.c0, ' slowed ', myPep.pronouns.their(names.c0g), ' pace as ', myPep.pronouns.they(names.c0g), ' approached the door, wondering if the aftermath in the shortcut had anything to do with the vault seemingly being unsecured. '),
p10as2b: pep.seq(''),
p10as2c: pep.seq(''),

p10as3a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' unsheathed ', myPep.pronouns.their(names.c0g), ' own dagger, gripping it with a white-knuckled ferocity.'),
p10as3b: pep.seq(''),
p10as3c: pep.seq(''),

  //p11
p11as1a: pep.seq(names.c0, ' peered around the corner, filled with apprehension. '),
p11as1b: pep.seq(''),
p11as1c: pep.seq(''),
...
p11as4a: pep.seq('Cautiously, ',names.c0, ' stepped across the threshold, dagger held at the ready. '),
p11as4b: pep.seq(''),
p11as4c: pep.seq(''),

p11as5a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' flipped ', myPep.pronouns.their(names.c0g), ' head left and right, scanning the walls for signs of an ambush. '),
p11as5b: pep.seq(''),
p11as5c: pep.seq(''),
...
p12as2a: pep.seq(names.c0, ' had not spent a lot of time in the vault -- only during orientation -- but nothing seemed out of place. '),
p12as2b: pep.seq(''),
p12as2c: pep.seq(''),
...
p12as4a: pep.seq('Nothing seemed out of the ordinary, other than the fact that ', names.c6, ' had said just this past evening that the portals were all closed down. '),
p12as4b: pep.seq(''),
p12as4c: pep.seq(''),
...
p12as5c: pep.seq(''),
  ...
  //p13
p13as1a: pep.seq('Heart racing, ', names.c0, ' sheathed ', myPep.pronouns.their(names.c0g), ' dagger and looked out into the abandoned hallway. '),
p13as1b: pep.seq(''),
p13as1c: pep.seq(''),

p13as2a: pep.seq('As if against ', myPep.pronouns.their(names.c0g), ' own will, ', names.c0, ' carefully pulled the vault door shut. '),
p13as2b: pep.seq(''),
p13as2c: pep.seq(''),
...
p13as4a: pep.seq(names.c0, ' heard a click as the door shut and ', myPep.pronouns.their(names.c0g), ' eyes went wide with panic. '),
p13as4b: pep.seq(''),
p13as4c: pep.seq(''),
...
p13as5c: pep.seq(''),
  ...
  //p14
p14as1a: pep.seq(names.c0, ' pushed on the door, but it would not budge. '),
p14as1b: pep.seq(''),
p14as1c: pep.seq(''),
...
p14as3a: pep.seq('How would ', names.c0, ' explain this in the morning when someone found ', myPep.pronouns.them(names.c0g), '? '),
p14as3b: pep.seq(''),
p14as3c: pep.seq(''),
...
p15as2a: pep.seq(names.c0, ' muttered as ', myPep.pronouns.they(names.c0g), ' paced in front of the locked the door. '),
p15as2b: pep.seq(''),
p15as2c: pep.seq(''),
...
p15as4c: pep.seq(''),
  ...
  //p16
p16as1a: pep.seq(names.c0, ' had a feeling that they would see through those flimsy excuses. '),
p16as1b: pep.seq(''),
p16as1c: pep.seq(''),

p16as2a: pep.seq(names.c0, ' knew why ', myPep.pronouns.they(names.c0g), ' had closed the door. '),
p16as2b: pep.seq(''),
p16as2c: pep.seq(''),

p16as3a: pep.seq('Even if ', myPep.pronouns.they(names.c0g), ' didn\'t want to admit it. '),
p16as3b: pep.seq(''),
p16as3c: pep.seq(''),
...
p16as5a: pep.seq(names.c0, ' heard the traitorous self-voice in the silence of the vault. '),
p16as5b: pep.seq(''),
p16as5c: pep.seq(''),

p16as6a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' hadn\'t closed the door to prevent escapes. '),
p16as6b: pep.seq(''),
p16as6c: pep.seq(''),

p16as7a: pep.seq('No one shut the door on ', myPep.pronouns.them(names.c0g), '. '),
p16as7b: pep.seq(''),
p16as7c: pep.seq(''),

p16as8a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' shut the door to escape -- and knew it. '),
p16as8b: pep.seq(''),
p16as8c: pep.seq(''),
...
p17as2a: pep.seq('Try to spin a story about why ', myPep.pronouns.they(names.c0g), ' were locked in the vault room by ', myPep.pronouns.themself(names.c0g), ', with the guard missing, or just go ahead and walk through the portal to freedom. '),
p17as2b: pep.seq(''),
p17as2c: pep.seq(''),

p17as3a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' stepped away from the door and looked at the portal. '),
p17as3b: pep.seq(''),
p17as3c: pep.seq(''),

p17as4a: pep.seq('It was now a blue-ish orange, and it seemed to be calling to ', myPep.pronouns.them(names.c0g), '. '),
p17as4b: pep.seq(''),
p17as4c: pep.seq(''),

p17as5a: pep.seq('Unlike many, ', myPep.pronouns.they(names.c0g), ' had never actually been through the portal. '),
p17as5b: pep.seq(''),
p17as5c: pep.seq(''),

p17as6a: pep.seq('By some small miracle, ', myPep.pronouns.they(names.c0g), ' had missed most of the hazing that occurred in basic training. '),
p17as6b: pep.seq(''),
p17as6c: pep.seq(''),

//p18
p18as1a: pep.seq('But ', myPep.pronouns.they(names.c0g), ' had heard the stories. '),
p18as1b: pep.seq(''),
p18as1c: pep.seq(''),

p18as2a: pep.seq('How the mortal realm was much like the ', myPep.setting.realm(names.setVar), ' realm, just devoid of magic and immortality. '),
p18as2b: pep.seq(''),
p18as2c: pep.seq(''),

p18as3a: pep.seq('How there was a rush in not-belonging, and a peacefulness to the mortal realm that was unlike anything ever experienced in ', myPep.setting.realm(names.setVar), '. '),
p18as3b: pep.seq(''),
p18as3c: pep.seq(''),

p18as4a: pep.seq('How there were no laws for those ', myPep.setting.brethrens(names.setVar), ' that walks on the other side. '),
p18as4b: pep.seq(''),
p18as4c: pep.seq(''),
...
p18as6c: pep.seq(''),
  ...
  //p19
p19as1a: pep.seq(myPep.html.i('o'), 'You can never come back, ', names.c0, '. '),
p19as1b: pep.seq(''),
p19as1c: pep.seq(''),
...
p19as3a: pep.seq('No more hanging out with ', names.c4, ' or bantering with ', names.c6, '. '),
p19as3b: pep.seq(''),
p19as3c: pep.seq(''),
...
p20as2a: pep.seq(names.c0, ' answered their silent musings out loud. '),
p20as2b: pep.seq(''),
p20as2c: pep.seq(''),
...
p20as4a: pep.seq(names.c5, ' has it out for me. '),
p20as4b: pep.seq(''),
p20as4c: pep.seq(''),
...
p20as6c: pep.seq(''),
  ...
  //p21
p21as1a: pep.seq(names.c0, ' drew closer to the portal. '),
p21as1b: pep.seq(''),
p21as1c: pep.seq(''),
...
p21as3a: pep.seq('It called to ', names.c0, ', the promise of a new life awaiting. '),
p21as3b: pep.seq(''),
p21as3c: pep.seq(''),

p21as4a: pep.seq('With nothing to lose, ', myPep.pronouns.they(names.c0g), ' jumped. '),
p21as4b: pep.seq(''),
p21as4c: pep.seq(''),
