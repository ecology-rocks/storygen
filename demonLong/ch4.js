...
//p1
p1as1a: pep.seq('The sun was uncomfortably warm against ', names.c0, '\'s skin as ', myPep.pronouns.they(names.c0g), ' sat on a hot park bench, squinting in the brightness. '),
p1as1b: pep.seq(),
p1as1c: pep.seq(),

p1as2a: pep.seq('The air was buzzing with life around ', myPep.pronouns.them(names.c0g), ', full of cicadas whining and birds singing. '),
p1as2b: pep.seq(),
p1as2c: pep.seq(),
...
p2as2a: pep.seq('Suddenly, ', names.c0, ' longed for a family of ', myPep.pronouns.their(names.c0g), ' own. '),
p2as2b: pep.seq(),
p2as2c: pep.seq(),

p2as3a: pep.seq(names.c0, '\'s parents were older and had never really made ', myPep.pronouns.them(names.c0g), ' feel wanted as a child, but these children, in contrast, seemed so happy. '),
p2as3b: pep.seq(),
p2as3c: pep.seq(),
...
p4as2a: pep.seq('The human muffed at ', names.c0, ' as it passed by. '),
p4as2b: pep.seq(),
p4as2c: pep.seq(),
...
p5as2a: pep.seq(names.c0, ' said. '),
p5as2b: pep.seq(),
p5as2c: pep.seq(),

p5as3a: pep.seq('The human seemed to wince at ', names.c0, '\'s words, and walked a little faster. '),
p5as3b: pep.seq(),
p5as3c: pep.seq(),

p5as4a: pep.seq(names.c0, ' frowned. '),
p5as4b: pep.seq(),
p5as4c: pep.seq(),
...
p5as5c: pep.seq(),
  ...
  //p6
p6as1a: pep.seq('The minutes passed and ', names.c0, ' tried ', myPep.pronouns.their(names.c0g), ' hardest to forget about what had just had happened in ', myPep.setting.realm(names.setVar), '. '),
p6as1b: pep.seq(),
p6as1c: pep.seq(),

p6as2a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0g)), ' had no choice after becoming trapped. '),
p6as2b: pep.seq(),
p6as2c: pep.seq(),

p6as3a: pep.seq('The punishment would\'ve been death or exile anyway -- and ', myPep.pronouns.they(names.c0g), ' preferred exile. '),
p6as3b: pep.seq(),
p6as3c: pep.seq(),


  //p7
p7as1a: pep.seq('In the distance, ', names.c0, ' heard the sounds of distress. '),
p7as1b: pep.seq(),
p7as1c: pep.seq(),

p7as2a: pep.seq('An ear-piercing scream cut across the park and straight into ', names.c0, '\'s heart. '),
p7as2b: pep.seq(),
p7as2c: pep.seq(),
...
p7as4c: pep.seq(),
  ...
  // p8
p8as1a: pep.seq(names.c0, ' rose from ', myPep.pronouns.their(names.c0g), ' resting place and walked past the parents who were hurriedly gathering their children to move away from the potential danger. '),
p8as1b: pep.seq(),
p8as1c: pep.seq(),
...
p8as4c: pep.seq(),
  ...
  //p9
p9as1a: pep.seq('Cresting the hill in front of ', myPep.pronouns.them(names.c0g), ', ', names.c0, ' saw pure and unfiltered chaos on the edge of the park. '),
p9as1b: pep.seq(''),
p9as1c: pep.seq(''),
...
p9as3a: pep.seq('It looked like something straight out of one of those pirated cult classic horror films that ', names.c0, '\'s parents had brought home from the mortal realm. '),
p9as3b: pep.seq(''),
p9as3c: pep.seq(''),
...
p10as4a: pep.seq('Unsure of what to do, ', names.c0, ' stood there for a while, trying to piece things together. '),
p10as4b: pep.seq(),
p10as4c: pep.seq(),

p10as5a: pep.seq(pep.capitalize(myPep.pronouns.they(names.c0)), ' noticed the rope from earlier descending from the feet of the human and into the gory mess. '),
p10as5b: pep.seq(),
p10as5c: pep.seq(),
  
p10as6a: pep.seq(names.c0, ' realized with a start that the body was the human\'s plump, happy, stupid little mutt from not 10 minutes ago. '),
p10as6b: pep.seq(),
p10as6c: pep.seq(),
...
p11as2a: pep.seq(names.c0, ' wondered as the sirens grew louder and louder. '),
p11as2b: pep.seq(''),
p11as2c: pep.seq(''),
