...
p1as1a: pep.seq('"Is ', fixed.c1, ' ', myPep.dict.insane, '?" '),
p1as1b: pep.seq('"Do you think this whole ', fixed.c1, ' stuff is ',myPep.dict.legit, '?" '),
p1as1c: pep.seq('"What do you think about our ', myPep.dict.impending, ' ', myPep.dict.doom, '?" '),

p1as2a: pep.seq(fixed.c0, ' ', myPep.dict.asked, ', ', myPep.dict.gnawing, ' ', myPep.pronouns.their(fixed.c0g), ' way through a piece of ', myPep.dict.overcooked, ' meat. '),
p1as2b: pep.seq(fixed.c0, ' ', myPep.dict.wondered, ' as ', myPep.pronouns.they(fixed.c0g), ' ', myPep.dict.gnawed, ' the final bites of ', myPep.pronouns.their(fixed.c0g), ' meal. '),
p1as2c: pep.seq('The question hung in the air as ', fixed.c0, ' took another bite. '),

p1as3a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' ', myPep.dict.looked, ' at ', myPep.pronouns.their(fixed.c0g), ' friend, ', fixed.c4, ', for reassurance. '),
p1as3b: pep.seq(fixed.c0, ' glanced at ',fixed.c4, ', weighing ', myPep.pronouns.their(fixed.c4g), ' expression. '),
p1as3c: pep.seq(fixed.c4, ' ', myPep.edIng(myPep.dict.cackling), '. '),

//p2
 
p2as1a: pep.seq('"', pep.capitalize(myPep.dict.perhaps), '." '),
p2as1b: pep.seq('"Does it matter?" '),
p2as1c: pep.seq('"You ', myPep.dict.always, ' ask the ', myPep.dict.tough, ' questions, ', fixed.c0, '." '),

p2as2a: pep.seq(fixed.c4, ' ', myPep.dict.wondered, ', ', myPep.dict.pushing, ' the tray away. '),
p2as2b: pep.seq(fixed.c4, ' pushed ', myPep.pronouns.their(fixed.c4g), ' ', myPep.dict.tray, ' away and ', myPep.dict.crossed, ' ', myPep.pronouns.their(fixed.c4g), ' arms. '),
p2as2c: pep.seq(fixed.c4, ' ',myPep.dict.grinned, ' a ', myPep.dict.toothy, ' ', myPep.dict.grin, ' at ', fixed.c0, '. '),

p2as3a: pep.seq('"But is anyone going to stop ',myPep.pronouns.them(fixed.c1g),'?" '),
p2as3b: pep.seq(fixed.c4, ' was ', myPep.aAn(myPep.dict.intimidating), ' ', myPep.dict.sight, ', even with ', myPep.dict.grape, ' ', myPep.dict.jelly, ' ', myPep.dict.drippingFrom, ' ', myPep.pronouns.their(fixed.c4g), ' ', myPep.dict.chin, '. '),
p2as3c: pep.seq('"There’s ', myPep.dict.nothing, ' we can do about it." '),

  //p3

p3as1a: pep.seq('That was the ', myPep.dict.issue, ', after all. '),
p3as1b: pep.seq('It was the ', myPep.dict.issue, ' on every ', myPep.setting.brethren(fixed.setVar), '\'s mind. '),
p3as1c: pep.seq('It was what kept ', myPep.setting.brethrens(fixed.setVar), ' up at night. '),

p3as2a: pep.seq('Would anyone ', myPep.dict.stop, ' ', fixed.c1, '’s ', myPep.dict.planned, ' ', myPep.dict.rebellion, ' against the ', myPep.setting.boss(fixed.setVar), '? '),
p3as2b: pep.seq('Would ', fixed.c1, ' ', myPep.dict.retreat, ' before it was too late? '),
p3as2c: pep.seq('Would anyone put ', fixed.c1, ' in ',myPep.pronouns.their(fixed.c1g), ' place? '),

p3as3a: pep.seq('Or were ', myPep.setting.brethrens(fixed.setVar), ' really that ', myPep.dict.frustrated, ' with the current ', myPep.setting.boss(fixed.setVar), '\'s style of rule? '),
p3as3b: pep.seq('Or were ', myPep.setting.brethrens(fixed.setVar), ' really that ', myPep.dict.apathetic, ' to ', myPep.dict.impending, ' ', myPep.dict.war, '?'),
p3as3c: pep.seq('Was it even possible? '),

p3as4a: pep.seq('It was ', myPep.dict.tough, ' to ', myPep.dict.ascertain, ', because there was ', myPep.dict.always, ' a level of ', myPep.dict.trouble, ' in ', myPep.setting.realm(fixed.setVar), ' -- but ', myPep.dict.somehow, ', it ', myPep.dict.seemed, ' like this time was ', myPep.dict.serious, '. '),
p3as4b: pep.seq('There had ', myPep.dict.always, ' been a level of ', myPep.dict.trouble, ' in ', myPep.setting.realm(fixed.setVar), ', but this time seemed more ', myPep.dict.serious, '. '),
p3as4c: pep.seq('The entire ', myPep.dict.realm, ' of ', myPep.setting.realm(fixed.setVar), ' ', myPep.dict.teetered, ' on ', myPep.dict.uncertainty, ' and ', myPep.dict.impending, ' ', myPep.dict.war, '. '),
...
p4as1a: pep.seq(fixed.c0, ' ', myPep.dict.savored, ' ', myPep.pronouns.their(fixed.c0g), ' ', myPep.dict.last, ' ', myPep.dict.morsel, '. '),
p4as1b: pep.seq(fixed.c0, ' was ', myPep.dict.suddenly, ' no longer ', myPep.dict.hungry, '. '),
...
p4as3c: pep.seq('Who cares who the ', myPep.setting.boss(fixed.setVar), ' is? '),
...
p5as1a: pep.seq(fixed.c4, ' ', myPep.dict.barked, ' a ', myPep.dict.harsh, ' ', myPep.dict.laugh, pep.opt(' in response'), '. '),
p5as1b: pep.seq(fixed.c4, ' ', myPep.edIng(myPep.dict.cackling), ' at ', fixed.c0, '\'s ', myPep.dict.bluntness, '. '),
p5as1c: pep.seq(fixed.c4, ' nodded ', myPep.dict.heartily, ' in ', myPep.dict.agreement, '. '),
...
p5as4a: pep.seq('Come on -- let\'s go before ', fixed.c5, ' gets ', myPep.dict.raging, ' ', myPep.dict.angry, '." '),
p5as4b: pep.seq('Let\'s get back before ', fixed.c5,' notices." '),
p5as4c: pep.seq('At least it\'s only a ', myPep.dict.few, ' hours to midnight." '),

  //p6
  
p6as1a: pep.seq(pep.choice(pep.seq(fixed.c4, ' and ', fixed.c0), 'They'), ' rose to place their trash in the bin and left the cafeteria to the dim skies outside. '),
p6as1b: pep.seq('Leaving their trash behind for the staff to clean, ',fixed.c4, ' and ', fixed.c0, ' left the cafeteria for the barren outdoors. '),
...
p6as4a: pep.seq(fixed.c4, ' said warmly to ', fixed.c0, ' as ', myPep.pronouns.they(fixed.c4g), ' strode off towards the west tower. '),
p6as4b: pep.seq(fixed.c4, ' left ', fixed.c0, ', veering right towards the west tower. '),
p6as4c: pep.seq(fixed.c4, ' put ', myPep.pronouns.they(fixed.c4g), ' cap on and strode off towards the west tower. '),
...
p7as2a: pep.seq('The military were the only ', myPep.setting.brethrens(fixed.setVar), ' allowed to carry weapons, so that meant that there was a pretty big barrier between insurgents, rabble-rousers, and troublemakers, and the military. '),
p7as2b: pep.seq('Only soldiers could carry weapons, so even the biggest revolts could be put down easily. '),
p7as2c: pep.seq('But every member of the military received a weapon, and no one else had them -- which made ', fixed.c0, ' feel safe. '),
...
p8as1c: pep.seq('Guards were on the front lines of defense, and ', fixed.c0, ' knew it. '),

p8as2a: pep.seq(fixed.c0, ' was worried that ', myPep.pronouns.they(fixed.c0g),' might actually have to use ', myPep.pronouns.their(fixed.c0g),' weapons. '),
p8as2b: pep.seq(fixed.c0, ' worried about whether ', myPep.pronouns.they(fixed.c0g),' would actually be able to kill if needed. '),
p8as2c: pep.seq(fixed.c0, ' didn\'t want to fight if worse came to worse. '),

p8as3a: pep.seq('As a pacifist, that was exceptionally unnerving. '),
p8as3b: pep.seq(fixed.c0, 'didn\'t want to shed blood. '),
p8as3c: pep.seq(fixed.c0, ' abhorred violence. '),
 
p8as4a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' had only taken this job for the pay, and because ', myPep.pronouns.they(fixed.c0g), ' were pressured to do so by ', myPep.pronouns.their(fixed.c0g), ' parents. '),
p8as4b: pep.seq('Without pressure from ', myPep.pronouns.their(fixed.c0g), ' parents, ', fixed.c0, ' never would have enlisted. '),
p8as4c: pep.seq(fixed.c0, ' only enlisted because of the free housing. '),
  
p8as5a: pep.seq('But there was no way in ', myPep.setting.realm(fixed.setVar), ', that ',fixed.c0, ' would willingly attack fellow ', myPep.setting.brethrens(fixed.setVar), '. '),
p8as5b: pep.seq('A civil war was somehow far worse than fighting imagined invaders from other realms. '),
p8as5c: pep.seq(fixed.c0, ' just couldn\'t kill their fellow ', myPep.setting.brethrens(fixed.setVar), '. '),

p8as6a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' would rather die or be imprisoned for treason. '),
p8as6b: pep.seq(fixed.c0, ' wished that ', myPep.pronouns.they(fixed.c0g), ' could quit, although it would mean death or imprisonment at the hand of the court. '),
p8as6c: pep.seq(fixed.c0, ' thought death or imprisonment might be better than shedding ', myPep.setting.brethren(fixed.setVar), ' blood. '),

p8as7a: pep.seq('Given the pending war, it may be the former. '),
p8as7b: pep.seq('Either would be better than this current unease. '),
p8as7c: pep.seq('What would ', fixed.c0, '\'s parents think? '),

//p9

p9as1a: pep.seq('"', fixed.c0, '! I need to talk to you!" '),
p9as1b: pep.seq('"Oy! Get over here!" '),
p9as1c: pep.seq('"Hey, shit head! Come here a second." '),
 
p9as2a: pep.seq('The commander, ', fixed.c5, ', barked, as ', fixed.c0, ' ducked through the doorway to resume ', myPep.pronouns.their(fixed.c0g), ' post. '),
p9as2b: pep.seq(fixed.c5, ' shouted at ', fixed.c0, '. '),
p9as2c: pep.seq(fixed.c5, ' spotted ', fixed.c0, ' with a shout. '),

p9as3a: pep.seq(fixed.c0, ' looked up, surprised. '),
p9as3b: pep.seq('The noise startled ', fixed.c0, '. '),
p9as3c: pep.seq(fixed.c0, '\'s stomach churned with surprise and trepidation. '),
...
p10as2a: pep.seq(fixed.c0, ' asked. '),
p10as2b: pep.seq(fixed.c0, ' looked genially at ', fixed.c5, '. '),
p10as2c: pep.seq(fixed.c5, ' shot ', fixed.c0, ' a dirty look. '),

p10as3a: pep.seq(pep.capitalize(myPep.pronouns.their(fixed.c0g)), ' stomach was letting ', myPep.pronouns.them(fixed.c0g), ' know that this may be ', myPep.pronouns.their(fixed.c0g), ' worst fear come to life. '),
p10as3b: pep.seq(fixed.c0, ' felt ', myPep.pronouns.their(fixed.c0g), ' courage waver. '),
p10as3c: pep.seq(fixed.c0, ' was suddenly hyper aware of ', myPep.pronouns.their(fixed.c0g), ' sweaty palms and inadequate stature. '),

  //p11

p11as1a: pep.seq('"Have you heard all this nonsense about ',fixed.c1, ' recently?" '),
p11as1b: pep.seq('"Have you heard about this impending tomfoolery?" '),
p11as1c: pep.seq('"Have you heard about ', fixed.c1, '?" '),

p11as2a: pep.seq(fixed.c5, ' asked with a growl, and ', fixed.c0, ' shrugged noncommittally. '),
p11as2b: pep.seq(fixed.c5, ' growled. '),
p11as2c: pep.seq(fixed.c5, ' adjusted their glasses and fixed their stare on ', fixed.c0, '. '),
...
p13as1b: pep.seq('"Listen, ',fixed.c0, '..." '),
p13as1c: pep.seq('"So, look..." '),

p13as2a: pep.seq(fixed.c5, ' trailed off as if trying to find a delicate way to state something offensive. '),
p13as2b: pep.seq(fixed.c5, ' paused as if gathering courage to say something. '),
p13as2c: pep.seq(fixed.c5, ' took a breath. '),

p13as3a: pep.seq('Though ', fixed.c5, ' had never been the polite sort. '),
p13as3b: pep.seq(fixed.c0, ' wondered what ', fixed.c5, ' was about to drop on ', myPep.pronouns.them(fixed.c0g), '. '),
...
p13as5a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c5g)), ' settled on cutting to the chase. '),
p13as5b: pep.seq(fixed.c5, ' continued. '),
p13as5c: pep.seq(fixed.c5, ' grinned sheepishly. '),
...
p14as3a: pep.seq(fixed.c0, ' cut ', fixed.c5, ' off before ', myPep.pronouns.they(fixed.c5g), ' could reiterate what ', fixed.c0, ' had failed to do. '),
p14as3b: pep.seq(fixed.c0, ' reassured the commander. '),
p14as3c: pep.seq(fixed.c0, ' blushed with embarrassment at being called out. '),

p14as4a: pep.seq(fixed.c0, ' felt the falseness of the words as they left ', myPep.pronouns.their(fixed.c0g), ' mouth. '),
p14as4b: pep.seq(fixed.c0, ' knew as soon as the words came out, that they were a lie.'),
p14as4c: pep.seq(fixed.c0, ' was lying, but it didn\'t matter.'),
...
p16as2a: pep.seq(fixed.c0, '\'s palms were itchy and a sheen of sweat was breaking out across ', myPep.pronouns.their(fixed.c0g), ' skin. '),
p16as2b: pep.seq(fixed.c0, ' was more than ready to get out of this conversation. '),
p16as2c: pep.seq(fixed.c0, '\'s mouth was full of ash. '),

p16as3a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' wondered if ', fixed.c5, ' noticed. '),
p16as3b: pep.seq('"Thank you for bringing this to my attention." '),
p16as3c: pep.seq(fixed.c0, ' felt their knees shaking just a little bit. '),
...
p17as2a: pep.seq(fixed.c5, ' finished. '),
p17as2b: pep.seq(fixed.c5, ' grunted at ', fixed.c0, '. '),
p17as2c: pep.seq(fixed.c0, ' nodded in agreement. '),
...
p18as2a: pep.seq(fixed.c0, ' asked. '),
p18as2b: pep.seq(fixed.c0, ' was confused. '),
p18as2c: pep.seq(fixed.c0, ' was unsure what ', fixed.c5, ' had just uttered. '),

p18as3a: pep.seq('Did the commander just say that ', myPep.pronouns.they(fixed.c0g), ' would die in battle? '),
p18as3b: pep.seq('Did the commander just threaten ', myPep.pronouns.them(fixed.c0), '? '),
...
p20as2a: pep.seq(fixed.c0, ' mustered all of the courage ', myPep.pronouns.they(fixed.c0g), ' could to make it sound convincing. '),
p20as2b: pep.seq(fixed.c0, ' knew that fixed.c5 was dead serious. '),
p20as2c: pep.seq(fixed.c0, ' felt the sweats come in ', myPep.pronouns.their(fixed.c0), ' fear. '),
...
p20as3c: pep.seq('"I would give my life for our ', myPep.setting.boss(fixed.setVar), '." '),

  //p21

p21as1a: pep.seq(fixed.c5,'’s searching gaze seemed to invade ',fixed.c0, '’s soul. '),
p21as1b: pep.seq(fixed.c5, ' stared menacingly at ', fixed.c0, '. '),
p21as1c: pep.seq('There was a moment of silence as ', fixed.c5, ' evaluated the truth of ', fixed.c0, '\'s statement. '),

p21as2a: pep.seq('But they could not -- thank the dogs -- detect the lie in it. '),
p21as2b: pep.seq('Thankfully, ', fixed.c5, ' seemed blissfully unaware of ', fixed.c0, '\'s nervousness. '),
p21as2c: pep.seq(fixed.c5, ' seemed ready to kill ', fixed.c0, ' at the slightest hint of doubt. '),

p21as3a: pep.seq(fixed.c5, ' nodded approvingly. '),
p21as3b: pep.seq(fixed.c5, ' smiled warmly at ', fixed.c0, '. '),
p21as3c: pep.seq(fixed.c5, ' seemed satisfied, though, and smiled. '),
...
p23as1a: pep.seq(fixed.c0, ' walked past the command desk and up the curling stairs to ', myPep.pronouns.their(fixed.c0g), ' post. '),
p23as1b: pep.seq(fixed.c0, ' carried onwards up the stairs. '),
p23as1c: pep.seq(fixed.c0, ' left the command post and headed upstairs to ', myPep.pronouns.their(fixed.c0), ' guard station. '),
 
p23as2a: pep.seq('The sweat was real. '),
p23as2b: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0)), ' felt hot and cold at the same time. '),
p23as2c: pep.seq('Sweat poured off of ', fixed.c0, '. ' ),

p23as3a: pep.seq(fixed.c0, ' was trembling. '),
p23as3b: pep.seq('Shaking with fear, ', myPep.pronouns.they(fixed.c0), ' finished the climb upwards. '),
p23as3c: pep.seq('Shaking like a leaf, ', fixed.c0, ' wondered if anything would come of the pending conflict. '),

p23as4a: pep.seq('Was war really that imminent? '),
p23as4b: pep.seq('Was ', fixed.c1, ' really about to take down the ', myPep.setting.boss(fixed.setVar), '? '),
p23as4c: pep.seq('Could war be on the horizon? '),
 
p23as5a: pep.seq('How could they get out of it? '),
p23as5b: pep.seq('How would ', fixed.c0, ' find a way to avoid fighting? '),
p23as5c: pep.seq('Would this particular town be safe from the horrors of war? '),

  //p24

p24as1a: pep.seq('Peering across the dusty landscape surrounding the compound, ', fixed.c0, ' idly wondered if ', myPep.pronouns.they(fixed.c0g), ' could fling ', myPep.pronouns.themself(fixed.c0g), ' from the ramparts. '),
p24as1b: pep.seq(fixed.c0, ' contemplated suicide by rampart as ', myPep.pronouns.they(fixed.c0), ' scanned the dusty landscape. '),
p24as1c: pep.seq(fixed.c0, ' briefly wondered if death was better than war. '),
  
p24as2a: pep.seq('After all, the hospitalized could not fight. '),
p24as2b: pep.seq('Even if ', myPep.pronouns.they(fixed.c0), ' didn\'t die, ', fixed.c0, ' could at least avoid the fighting. '),
p24as2c: pep.seq('But what if ', myPep.pronouns.they(fixed.c0), ' failed even at suicide? '),

p24as3a: pep.seq('Then again, ', myPep.pronouns.they(fixed.c0g), ' could end up dead, or worse, especially if the invading forces took control of the hospital. '),
p24as3b: pep.seq('Or maybe invading forces would not look kindly at prisoners of war. '),
p24as3c: pep.seq('Likely, ', myPep.pronouns.they(fixed.c0), ' would be killed anyway by invading forces. '),
 
p24as4a: pep.seq(myPep.setting.brethrens(fixed.setVar), ' were not kind in civil war. '),
p24as4b: pep.seq(myPep.setting.brethrens(fixed.setVar), ' did not fuck around in times of war. '),
p24as4c: pep.seq(fixed.c0, ' would not last long in the hands of ', myPep.pronouns.their(fixed.c0), ' enemies. '),

p24as5a: pep.seq('There were no rules to follow. '),
p24as5b: pep.seq('There was no Geneva Convention in ', myPep.setting.realm(fixed.setVar), '. '),
...
p25as1a: pep.seq('Looking down the thirty foot drop though, ', fixed.c0, ' decided that perhaps suicide was not the best way. '),
p25as1b: pep.seq('Looking down into the chasm, ', fixed.c0, ' decided that suicide was not for ', myPep.pronouns.them(fixed.c0), '. '),
p25as1c: pep.seq(fixed.c0, ' shied away from thoughts of suicide. '),
...
p25as3a: pep.seq('Could ', myPep.pronouns.they(fixed.c0g), ' request a transfer to the medical or other nonviolent units? '),
p25as3b: pep.seq('Maybe ', myPep.pronouns.they(fixed.c0), ' could request a transfer. '),
p25as3c: pep.seq('Maybe ', myPep.pronouns.they(fixed.c0), ' could request a promotion. '),
  
p25as4a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' could -- but ', myPep.pronouns.they(fixed.c0g), ' would be laughed at, for ', myPep.pronouns.they(fixed.c0g), ' had no marketable skills. '),
p25as4b: pep.seq('The commander wouldn\'t go for it. ' ),
p25as4c: pep.seq('That plan was doomed to fail. '),

  //p26

p26as1a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' could join the revolution, although then ', myPep.pronouns.they(fixed.c0g), '’d just be fighting for the otherside, and ', fixed.c0, ' doubted that they were kinder. '),
p26as1b: pep.seq(fixed.c0, ' contemplated joining the rebellion. '),
p26as1c: pep.seq(fixed.c0, ' wondered if joining the rebellion would somehow be safer. '),
...
p26as4a: pep.seq('Either could help ', fixed.c0, ' forego battle, although ', fixed.c0, ' had a feeling that no vacations were being approved in this particular moment in time. '),
p26as4b: pep.seq('Either would help ', fixed.c0, ' avoid battle, but they weren\'t exactly easy solutions. '),
p26as4c: pep.seq(fixed.c0, ' knew that these were just fantasies. '),
...
p27as2a: pep.seq(fixed.c6, '\'s voice came from behind ', fixed.c0, ', startling them.'),
p27as2b: pep.seq(fixed.c6, ' spoke behind ', fixed.c0, '. '),
p27as2c: pep.seq(fixed.c6, ' blew cigar smoke in ', fixed.c0, '\'s face as ', myPep.pronouns.they(fixed.c6), ' approached. '),
...
p28as2a: pep.seq(fixed.c0, ' said incredulously. '),
p28as2b: pep.seq(fixed.c0, ' was surprised. '),
p28as2c: pep.seq(fixed.c0, ' couldn\'t tell if ', fixed.c6, ' was kidding. '), 
  
//p29

p29as1a: pep.seq('"Yeah, no one is supposed to leave or enter until this whole mess with ', fixed.c1, ' is done." '),
p29as1b: pep.seq('"They\'ve got the portals under lock and key until ', fixed.c1, ' is dealt with." '),
p29as1c: pep.seq('"Yeah, portals are closed and there\'s a bounty on ', fixed.c1, ', too." '),

p29as2a: pep.seq(fixed.c6, ' huffed on a cigarette, releasing a long trail of white smoke. '),
p29as2b: pep.seq(fixed.c6, ' took another drag of ', myPep.pronouns.their(fixed.c6), ' cigar. '),
p29as2c: pep.seq(fixed.c6, ' nodded sagely. '),
...
p30as2a: pep.seq(fixed.c0, ' said. '),
p30as2b: pep.seq(fixed.c0, ' chewed on the words for a moment. '),
p30as2c: pep.seq(fixed.c0, ' felt the unease grow inside ', myPep.pronouns.them(fixed.c0), '. ' ),
...
p31as2c: pep.seq('I can\'t believe the ', myPep.setting.boss(fixed.setVar), ' let it get this far. '),

p31as3a: pep.seq('I\'d hate to get blood on my brand new dagger." '),
p31as3b: pep.seq('I didn\'t want to blood my new dagger on ', myPep.setting.brethrens(fixed.setVar), '." '),
p31as3c: pep.seq('I didn\'t actually want to use this dagger." '),

p31as4a: pep.seq(fixed.c6, ' hefted a shiny blade from ', myPep.pronouns.their(fixed.c6g), ' waist belt. '),
p31as4b: pep.seq(fixed.c6, ' displayed a bright new blade from ', myPep.pronouns.their(fixed.c6), ' belt. '),
p31as4c: pep.seq(fixed.c6, ' fingered a blade on ', myPep.pronouns.their(fixed.c6), ' belt. '),
...
p32as1a: pep.seq(fixed.c0, ' paused a moment, weighing what to say to that ridiculously, flat toned desire to murder. '),
p32as1b: pep.seq(fixed.c0, ' gathered thoughts before speaking. '),
p32as1c: pep.seq(fixed.c0, ' wasn\'t sure how to respond. '),

p32as2a: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0g)), ' settled on an ambivalent nod and grunt. '),
p32as2b: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c0)), ' decided on a smile. '),
p32as2c: pep.seq('Smiling, ', fixed.c0, ' nodded at ', fixed.c6, '. ' ),
...
p33as2a: pep.seq(fixed.c6, ' said, pocketing the blade. '),
p33as2b: pep.seq(fixed.c6, ' sheathed the blade. '),
p33as2c: pep.seq(fixed.c6, ' grinned at fixed.c0. '),

p33as3a: pep.seq('"Commander thinks you’re going to break first. '),
p33as3b: pep.seq('"', fixed.c6, ' says you\'re our first and biggest coward." '),
p33as3c: pep.seq('"', fixed.c6, ' is saying you\'ll break rank and run when the time comes." '),

p33as4a: pep.seq('You aren’t, are you, ', fixed.c0, '? '),
...
p34as1a: pep.seq('"Fuck ', fixed.c5, '." '),
p34as1b: pep.seq('"Fuck this place." '),
p34as1c: pep.seq('"This place could burn up for all I care." '),

p34as2a: pep.seq(fixed.c0, ' said rashly. '),
p34as2b: pep.seq(fixed.c0, ' spoke without a waver in ', myPep.pronouns.their(fixed.c0), ' voice. '),
p34as2c: pep.seq(fixed.c0, ' did not hesitate to speak rashly. '),

p34as3a: pep.seq('Boldly. '),
p34as3b: pep.seq(fixed.c0, ' felt reckless. '),
...
p34as6a: pep.seq(fixed.c0, ' felt the lie like a wet blanket. '),
p34as6b: pep.seq(fixed.c0, ' knew ', myPep.pronouns.they(fixed.c0), ' were veering into dangerous territory. '),
p34as6c: pep.seq(fixed.c0, ' was straight up lying. '),

p34as7a: pep.seq('But ', fixed.c6, ' had an unblooded knife, and ', fixed.c0, ' wasn\'t about to be its maiden voyage. '),
p34as7b: pep.seq('But ', fixed.c6, ' had a knife, so honesty wasn\'t an option. '),
p34as7c: pep.seq('Anything to keep ', myPep.pronouns.them(fixed.c0), ' alive another day. '),

  //p35

p35as1a: pep.seq(fixed.c6, '\'s eyes widened at the outright insult to the commander. '),
p35as1b: pep.seq(fixed.c6, ' flinched when ', fixed.c0, ' insulted the commander. '),
p35as1c: pep.seq(fixed.c6, ' looked perplexed at ', fixed.c0, '\'s resolve. '),

p35as2a: pep.seq('That, apparently, took courage to say out loud. '),
p35as2b: pep.seq(pep.capitalize(myPep.pronouns.they(fixed.c6)), ' had not expected such furor from ', fixed.c1, '. '),
p35as2c: pep.seq(fixed.c6, ' was utterly taken aback by ', fixed.c0, '\'s boldness. '),

p35as3a: pep.seq(fixed.c6, ' slapped ', fixed.c0, ' on the back. '),
p35as3b: pep.seq(fixed.c6, ' grinned. '),
p35as3c: pep.seq(fixed.c6, ' seemed satisfied. '),
